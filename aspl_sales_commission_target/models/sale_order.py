...
class SaleConfiguration(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update({
            'commission_pay_on': param_obj.sudo().get_param('aspl_sales_commission_target.commission_pay_on'),
            'commission_pay_by': param_obj.sudo().get_param('aspl_sales_commission_target.commission_pay_by'),
            'commission_included_amount': param_obj.sudo().get_param('aspl_sales_commission_target.commission_included_amount'),
            'dist_commission_pay_on': param_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_pay_on'),
            'dist_commission_pay_by': param_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_pay_by'),
            'dist_commission_included_amount': param_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_included_amount'),
            'cons_commission_pay_on': param_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_pay_on'),
            'cons_commission_pay_by': param_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_pay_by'),
            'cons_commission_included_amount': param_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_included_amount'),
        })
        return res
    ...
    def set_values(self):
        ...
        param_obj = self.env['ir.config_parameter']
        param_obj.sudo().set_param('aspl_sales_commission_target.commission_pay_on',self.commission_pay_on)
        param_obj.sudo().set_param('aspl_sales_commission_target.commission_pay_by', self.commission_pay_by)
        param_obj.sudo().set_param('aspl_sales_commission_target.commission_included_amount', self.commission_included_amount)
        param_obj.sudo().set_param('aspl_sales_commission_target.dist_commission_pay_on', self.dist_commission_pay_on)
        param_obj.sudo().set_param('aspl_sales_commission_target.dist_commission_pay_by', self.dist_commission_pay_by)
        param_obj.sudo().set_param('aspl_sales_commission_target.dist_commission_included_amount', self.dist_commission_included_amount)
        param_obj.sudo().set_param('aspl_sales_commission_target.cons_commission_pay_on', self.cons_commission_pay_on)
        param_obj.sudo().set_param('aspl_sales_commission_target.cons_commission_pay_by', self.cons_commission_pay_by)
        param_obj.sudo().set_param('aspl_sales_commission_target.cons_commission_included_amount', self.cons_commission_included_amount)
...
class CommissionCalculationDetails(models.Model):
    ...
    so_invoice_id = fields.Many2one('account.move', string="Account Invoice", readonly=True)
    invoice_line_id = fields.Many2one('account.move.line', string="Related Invoice Line")
...
class SaleOrder(models.Model):
    ...
    def order_calculate_commission(self, ptype, commission_pay_by):
        ...
        for commline in self.sale_order_comm_ids.filtered(lambda l:l.commission_type == ptype):
            ...
            if vals['amount'] != 0.0:
                comm_id = comm_obj.sudo().create(vals)
    ...
    def _compute_commission_data(self):
        ...
        details_lst = []
        ir_config_obj = self.env['ir.config_parameter']
        sale_comm_inc_amount = ir_config_obj.sudo().get_param('aspl_sales_commission_target.commission_included_amount') if ir_config_obj.sudo().get_param('aspl_sales_commission_target.commission_included_amount') else 'without_tax'
        dist_comm_inc_amount = ir_config_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_included_amount') if ir_config_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_included_amount') else 'without_tax'
        cons_comm_inc_amount = ir_config_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_included_amount') if ir_config_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_included_amount') else 'without_tax'
        commission_pay_on = ir_config_obj.sudo().get_param('aspl_sales_commission_target.commission_pay_on')
        cons_commission_pay_on = ir_config_obj.sudo().get_param('aspl_sales_commission_target.cons_commission_pay_on')
        dist_commission_pay_on = ir_config_obj.sudo().get_param('aspl_sales_commission_target.dist_commission_pay_on')
